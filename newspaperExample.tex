...
\begin{figure}[ht]
  \begin{center}
    \input{zero_dark_thirty_probabilistic_graphical_model}
  \end{center}
  \caption{Zero Dark Thirty Usama Bin Laden location as a Probabilistic Graphical Model (PGM). $T$ represents the Bernoulli likelihood variable, $\Sigma$ represents the uncertainty in the chances that UBL is at the compound and $\Theta$ and $\Phi$ define some ''uninformative'' or smoother prior on the likelihood $T$.}
\end{figure}

\begin{thebibliography}{9}

\bibitem[Peck, M. Scott. People of the Lie. Simon and Schuster, 1983.]{liepeople}

\bibitem[Eagleton, Terry. On evil. Yale University Press, 2010.]{onevil}
